...
function Dashboard() {
  ...
  const {
    ...
    error: errorExpenses,
  } = useFetch(`/lastMonthExpenseList/${user ? user.userId : ""}`, [
    user,
    isExpenseCreated,
    isExpenseUpdated,
    isExpenseDeleted,
  ...
  const {
    ...
    error: errorIncomes,
  } = useFetch(`/incomeListLastMonth/${user ? user.userId : ""}`, [
    user,
    isIncomeCreated,
    isIncomeUpdated,
    isIncomeDeleted,
  ...
  } = useFetch(`/fixedExpenseListLastMonth/${user ? user.userId : ""}`, [
    user,
  ...
  if (
    ...
    loadingTotalExpenseMonth ||
    loadingTotalIncomeMonth ||
  ...
  if (
    ...
    errorMonthlyRecord ||
    errorFixedExpenses ||
    errorTotalExpenseMonth ||
    errorTotalIncomeMonth ||
    errorMonthlyRecords
  ) {
  ...
  return (
    <>
      ...
      <Box className="containerDashboard">
        ...
        >
          <Typography className="cabin-sketch-bold">Ingresos</Typography>
          <IncomeTable
            incomes={incomes}
            userId={user.userId}
          ...
          <Typography className="cabin-sketch-bold">Gastos Fijos</Typography>
          <FixedExpenseTable
        ...
        <Box className="rightBar">
          <Typography className="cabin-sketch-bold">Gastos Diarios</Typography>
          <ExpenseTable
            expenses={expenses}
            userId={user.userId}
          ...
          <Box className="resumeBox">
            <Tabs
              ...
              TabIndicatorProps={{
                style: { background: "#a3966a", color: "#895d2b" },
              }}
            >
              <Tab
            ...
            {tabValue === 2 && <AnualRecord records={monthlyRecords} />}
          </Box>
        </Box>
      </Box>
    </>
