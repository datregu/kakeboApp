      ...
      >
        <Table size="small">
          <TableHead className="table-head">
            <TableRow>
              <TableCell
                sx={tableHeadStyle}
                className="shantell-sans-fontHeadTable"
              >
                Fecha
              </TableCell>
              <TableCell
              ...
              <TableCell
                sx={{ ...tableHeadStyle, verticalAlign: "center" }}
                className="shantell-sans-fontHeadTable"
              ></TableCell>
              <TableCell
                sx={tableHeadStyle}
            ...
            {incomes
              ...
              .map((income) => (
                ...
                >
                  ...
                  <TableCell align="right" style={tableCellStyle}></TableCell>
                  <TableCell align="right" style={tableCellStyle}>
                    <MenuIcon />
                  </TableCell>
                </TableRow>
        ...
        >
          <div style={{ display: "flex", padding: "10px" }}>
            ...
            <IconButton
              onClick={() => handleDeleteIncome(incomeToEdit.incomeId)}
            >
        ...
        >
          ...
          <DialogContent>
            <TextField
              ...
              onChange={(e) =>
                setNewIncome({ ...newIncome, incomeAmount: e.target.value })
              }
            />
            <TextField
              margin="dense"
              ...
              onChange={(e) =>
                setNewIncome({
                  ...newIncome,
                  incomeDescription: e.target.value,
                })
              }
            />
            <TextField
              ...
              onChange={(e) =>
                setNewIncome({ ...newIncome, incomeDate: e.target.value })
              }
            />
          </DialogContent>
          <DialogActions>
