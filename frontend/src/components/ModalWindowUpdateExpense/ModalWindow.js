...
const ModalWindow = ({ open, handleClose, title, expense, userId, setIsExpenseUpdated }) => {
    const user_id = 1;
    ...
    const handleUpdateExpense = () => {
        if (!expenseData.expenseAmount || !expenseData.expenseDate || !expenseData.expenseDescription || !expenseData.expenseCategory) {
        ...
        console.log('Sending the following data:', JSON.stringify(expenseDataToSend));
            ...
            <Fade in={open}>
                <Box sx={{
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                        ...
                        <input
                            type="date"
                            value={expenseData.expenseDate instanceof Date ? expenseData.expenseDate.toISOString().substr(0, 10) : ''}
                            onChange={(event) => {
                                setExpenseData({
                                    ...expenseData,
                        ...
                        />
                        <TextField name="expenseDescription" label="Descripción" value={expenseData.expenseDescription} onChange={handleChange}/>
                        <Select
